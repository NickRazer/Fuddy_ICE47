...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            # imagebutton auto "gui/button_start.png"
            
               
            # imagebutton:
                
            #     # auto "gui/button_start_%s.png"
            #     idle "gui/button_start_idle.png"
            #     hover "gui/button_start_hover.png" 
            #     action Jump ("Start")
                
            # imagebutton:
               
            #     # auto "gui/info_%s.png"
            #     idle "gui/info_idle.png"
            #     hover "gui/info_hover.png"
            #     action Jump ("info")
                
        # else:
        #     imagebutton auto "gui/button_start_idle_%s.png" xpos 761 ypos 345 focus_mask True action Start()
...
screen main_menu():
    ...
    #         imagebutton auto "gui/button_start_%s.png" xpos 761 ypos 345 focus_mask True action Start()
               
    #         # imagebutton:
    #         #     idle "gui/button_start_idle.png" xalign 0.5 ypos 70
    #         #     hover "gui/button_start_hvr1.png"
    #         #     action Jump ("Start")
                
    #         # imagebutton:
    #         #     idle "gui/info_idle.png" xalign 0.5 ypos 1000
    #         #     hover "gui/info_hv.png"
    #         #     action Jump ("info")
